...
data class TransactionEntity(
    ...
    fun toDomainModel(): Transaction {
        return Transaction(
            ...
            recurringEndsInclusiveDate = recurringEndsInclusiveDate,
            recurringAmountPending = recurringAmountPending,
            recurringAmountEffectiveOn = recurringAmountEffectiveOn,
    ...
    companion object {
        fun fromDomainModel(transaction: Transaction): TransactionEntity {
            return TransactionEntity(
                ...
                recurringEndsInclusiveDate = transaction.recurringEndsInclusiveDate,
                recurringAmountPending = transaction.recurringAmountPending,
                recurringAmountEffectiveOn = transaction.recurringAmountEffectiveOn,
